...
class UserTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.object1 = User.objects.create(email = "Taylor", password = "Swift")
        self.object1.save()
    ...
    def test_UserUsernameExists(self):
        ...
        self.assertTrue(User.objects.filter(email = "Taylor").exists(), msg = "Username does not exist despite creation of user.")
    ...
    def test_UserCorrectUsernameField(self):
        ...
        self.assertEqual(User.objects.first().email, "Taylor", msg = "The User object that was created does not have the correct username.")
    ...
    def test_UserUsernameBlank(self):
        ...
        with self.assertRaises(ValueError, msg = "Username is a blank field, but did not fail"):
            self.object1 = User.objects.create_user(email = "")
            self.object1.save()
    ...
    def test_UserPasswordBlank(self):
        ...
        with self.assertRaises(Exception, msg = "Username is a blank field, but did not fail"):
            self.object1 = User.objects.create(email = "Taylor", password = "")
            self.object1.save()
...
class SectionTestCases(TestCase):
    def setUp(self):
        ...
        self.object1 = Section.objects.create(id = 100)
        self.object1.save()
